...
export default async function AboutPage() {
  ...
  return <main id="conteudo">
    ...
    <section className="content-section"><div className="shell narrow-content">
      <div className="institution-facts"><div><span>Natureza</span><strong>Entidade sindical patronal</strong></div><div><span>CNPJ</span><strong>04.702.939/0001-59</strong></div><div><span>Presidência</span><strong>Ademar Bayer</strong></div><div><span>Sede</span><strong>Marechal Cândido Rondon — PR</strong></div></div>
      <div className="prose-grid"><div><span className="eyebrow">Quem somos</span><h2>Uma voz coletiva para o comércio varejista.</h2></div><div className="rich-text"><p>O Sindicomar representa a categoria econômica patronal e atua para que os interesses comuns das empresas sejam tratados de forma organizada nas relações coletivas e institucionais.</p><p>Sua presença aproxima empresários, gestores, profissionais de RH e contadores de informações, canais de atendimento e iniciativas voltadas ao desenvolvimento do comércio regional.</p></div></div>
      <div className="value-grid"><article><Target /><h3>Representar</h3><p>Defender pautas coletivas e levar a realidade do comércio ao diálogo institucional.</p></article><article><ShieldCheck /><h3>Orientar</h3><p>Organizar o acesso a instrumentos, comunicados e atendimento responsável.</p></article><article><Handshake /><h3>Conectar</h3><p>Aproximar empresas, entidades e oportunidades relevantes para o setor.</p></article></div>
    </div></section>
