...
function DocumentUploadField({ existingPath, existingUrl, selectedFile, selectedUrl, onSelect }: { existingPath: string; existingUrl: string; selectedFile: File | null; selectedUrl: string; onSelect: (file: File | null) => void }) {
  const fileInputRef = useRef<HTMLInputElement>(null);
